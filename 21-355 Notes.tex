...
\emph{Proof}: The function $\psi : \mathbb{R} \to \mathbb{R}$ where $\phi(x) = x^2$ is cont. on $\mathbb{R}$. By the last theorem, if $h \in \mathcal{R}([a,b]; \alpha)$ then $h^2 \in \mathcal{R}([a,b]; \alpha)$. Note that $fg = \frac{1}{4}(f+g)^2 - \frac{1}{4} (fg)^2 \in \mathcal{R}([a,b]; \alpha)$ since $f \pm g \in \mathcal{R}([a,b]; \alpha)$.
