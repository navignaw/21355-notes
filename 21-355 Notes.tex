...
\textbf{Definition}: Let $a,b \in \mathbb{R}$ with $a \leq b$. A partition of $[a,b]$ is a finite ordered set $P = \{x_0, \ldots, x_n\}$ such that $a = x_0 \leq x_1 \leq \cdots \leq x_n = b$. Write $\mathcal{P}[a,b] = \{P \;|\; P \text{ is a partition of }[a,b]\}$. For brevity we'll write $\mathcal{P} = \mathcal{P}[a,b]$.
